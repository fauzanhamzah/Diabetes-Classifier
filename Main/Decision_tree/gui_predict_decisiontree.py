...
class Diabetes(QWidget):
    ...
    def __init__(self) -> None:
        ...
        self.sub_head.setFont(QFont("Times", 18, weight=QFont.Bold))
        self.l0 = QLineEdit()
        self.l1 = QLineEdit()
        self.l2 = QLineEdit()
        self.l3 = QLineEdit()
    ...
    def report_ui(self):
        ...
        self.report_subhead.setFont(QFont("Times", 20, weight=QFont.Bold))
        self.v2_box.addWidget(self.report_subhead)
        self.details.setFont(QFont("Arial", 12, weight=QFont.Bold))
    ...
    def test_input(self) -> None:
        ...
        output = train_decisiontree.check_input(my_dict)
        # print(self.output)
...
\nPlasma glucose concentration: {}\nAge (years): {}\nPregnancies: {}\nBody mass index: {}".format(
        ...
        if output == 0:
            ...
            self.results.setText(
                " Class = 1 (Positif)")
        self.results.setFont(QFont("Arial", 12, weight=QFont.Bold))
